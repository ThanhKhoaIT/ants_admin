require 'ants_admin/strategies/base'
...
module AntsAdmin
  module Strategies
    ...
    private
      ...
      # given as parameter. Check AntsAdmin::Models::Authenticable.valid_for_authentication?
      ...
      def remember_me?
        valid_params? && AntsAdmin::TRUE_VALUES.include?(params_auth_hash[:remember_me])
      end
      ...
      def valid_params_request?
        !!env["ants_admin.allow_params_authentication"]
      end
      ...
      # Holds the authenticatable name for this class. AntsAdmin::Strategies::DatabaseAuthenticatable
