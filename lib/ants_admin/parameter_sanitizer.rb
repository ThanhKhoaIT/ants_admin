module AntsAdmin
  class BaseSanitizer
    ...
    def default_for(kind)
      raise ArgumentError, "a block is expected in AntsAdmin base sanitizer"
    end
  ...
  class ParameterSanitizer < BaseSanitizer
    ...
    def default_sanitize(kind)
      if respond_to?(kind, true)
        ...
        raise NotImplementedError, "AntsAdmin doesn't know how to sanitize parameters for #{kind}"
      end
    end
